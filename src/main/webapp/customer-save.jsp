  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <button type="submit" class="btn btn-danger">REGISTER</button>
        <button type="button" class="btn btn-warning"><a href="customer-delete.jsp">Delete</a></button>
      <button type="button" class="btn btn-success"> <a href="customer-list.jsp">Virw Users</a></button>
